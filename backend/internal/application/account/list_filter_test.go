...
// The egress narrowing filter (bound/node:<id>/source:<id>) was removed with
// account-proxy binding: nodes and pools are scope-free resources and account
// lists no longer filter by egress assignment.
