...
func (s *Selector) currentClaimCandidate(ctx context.Context, candidate account.RoutingCandidate, criteria selectionCriteria, tracker *selectionClaimTracker) (account.RoutingCandidate, error) {
	...
	if err := s.candidateEligibility(criteria.provider, criteria.upstreamModel, criteria.quotaMode, candidate, candidate.Credential, criteria.accountScope, now, criteria.inference, true, criteria.allowQuotaRecovery); err != nil {
