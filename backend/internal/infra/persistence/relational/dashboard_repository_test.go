...
func TestDashboardRepositorySnapshot(t *testing.T) {
	...
	rows := []any{
		...
		&clientKeyModel{Name: "internal", Prefix: "internal-tool-key", SecretHash: testSecretHash, EncryptedSecret: testEncryptedToken, InternalKind: &internalKind, Enabled: true},
	}
