...
var catalog = []ModelSpec{
	...
	// distinct from the Console resource API. Image editing and the default
	// 720p video product are also available to Basic accounts, with runtime
	// selection fenced by their tier-specific upstream quota windows.
