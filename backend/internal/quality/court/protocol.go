...
func casePolicy(record registry.CaseRecord, cfg Config) ExperimentPolicy {
	var envelope struct {
...
func assessExperiment(tasks []registry.ProbeTaskView, policy ExperimentPolicy) ExperimentReport {
