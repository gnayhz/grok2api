...
// AuditRepository commits the first event identity, audit details, billing and
// reservation release atomically. Same-Key replays keep the first commit even
// after diagnostic retention; a different Key cannot reuse that identity.
