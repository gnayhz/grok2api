...
const resources = {
	"zh-CN": { translation: { ...sharedResources["zh-CN"].translation, ...featureTranslationBundles["zh-CN"] } },
	en: { translation: { ...sharedResources.en.translation, ...featureTranslationBundles.en } },
};
const zh = new Map<string, string>();
const en = new Map<string, string>();
collectKeys(resources["zh-CN"].translation as Tree, "", zh);
collectKeys(resources.en.translation as Tree, "", en);
