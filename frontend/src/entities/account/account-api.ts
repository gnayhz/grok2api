...
import { createAccountTaskProgressController, type AccountTaskProgressDTO, type AccountTaskProgressPhase } from "@/entities/account/account-task-progress";

export type { AccountTaskProgressDTO } from "@/entities/account/account-task-progress";
...
type AccountTokenRefreshResultDTO = AccountBatchResultDTO & { skipped: number };
...
type AccountSyncStrategy = "missing" | "all";
export type BuildConversionStrategy = AccountSyncStrategy;
type WebConsoleSyncStrategy = AccountSyncStrategy;
...
type WebConsoleSyncResultDTO = AccountImportResultDTO & { skipped: number };
