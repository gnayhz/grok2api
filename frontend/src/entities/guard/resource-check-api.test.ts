...
test("proof batches decode a durable reservation and shared per-resource certificates", () => {
  ...
  const report = { version: "resource-proof-v2", kind: "account", resource_id: "1", outcome: "inconclusive", reason: "insufficient_controls", calls: 1, max_calls: 6, groups: [], generations: 0, path_checks: 0,
