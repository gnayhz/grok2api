...
import { ArrowUp, AudioLines, Check, Clock3, ExternalLink, Globe, History, ImageIcon, ImagePlus, ImageUpscale, Images, Loader2, MessageSquareText, Mic, Sparkle, Square, SquarePen, Trash2, TvMinimal, Upload, Video, X } from "lucide-react";
...
import {
  ...
  type VideoStatus,
  type VoiceInfo,
} from "@/entities/creative-console/creative-console-api";
import { getClientKeySecret, listClientKeys, type ClientKeyDTO } from "@/entities/client-key/client-key-api";
import { SpeechPlayback } from "./speech-playback";
import { importVideoInputFromURL, uploadMediaInput } from "@/entities/media/media-api";
import { PageHeader } from "@/shared/components/page-header";
import { cn } from "@/shared/lib/cn";
import { isAbortError } from "@/shared/lib/is-abort-error";
import { ChatMessageItem, InlineError, LoadingResult, RetryableError, XSocialIcon, type ConversationMessage } from "./chat-message-views";
...
export function CreativeConsolePage() {
  ...
  return (
    <div className="flex h-[calc(100dvh-5rem)] lg:h-[calc(100dvh-36px)] min-h-[36rem] flex-col gap-5 overflow-hidden">
