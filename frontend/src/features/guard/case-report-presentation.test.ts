...
const report: ResourceReport = { version: "resource-proof-v2", kind: "account", resource_id: "7", outcome: "healthy", reason: "proved_normal", calls: 1, max_calls: 5, groups: [], results: [proof] };
