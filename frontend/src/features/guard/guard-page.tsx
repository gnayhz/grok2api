        ...
        <Tabs defaultValue="stats" className="gap-5">
          ...
          <SettingsSection title={t("settings.accountRisk.title")} action={
            ...
            <div className="space-y-0">
              ...
              <SettingsField controlId="account-risk-probe-proxy" className="sm:col-span-2" label={t("settings.accountRisk.probeProxyURL")} description={t("settings.accountRisk.probeProxyURLHelp")} error={form.formState.errors.accountRisk?.probeProxyURL?.message}><Input id="account-risk-probe-proxy" placeholder="socks5://127.0.0.1:1080" {...form.register("accountRisk.probeProxyURL")} /></SettingsField>
              <SettingsField controlId="account-risk-denied-confirmations" label={t("settings.accountRisk.deniedConfirmations")} description={t("settings.accountRisk.deniedConfirmationsHelp")} error={form.formState.errors.accountRisk?.deniedConfirmations?.message}><Input id="account-risk-denied-confirmations" type="number" min={0} max={5} {...form.register("accountRisk.deniedConfirmations", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="account-risk-denied-ttl" label={t("settings.accountRisk.deniedTTL")} description={t("settings.accountRisk.deniedTTLHelp")} error={form.formState.errors.accountRisk?.deniedTTL?.message}><Controller control={form.control} name="accountRisk.deniedTTL" render={({ field }) => <DurationInput id="account-risk-denied-ttl" value={field.value} onChange={field.onChange} />} /></SettingsField>
