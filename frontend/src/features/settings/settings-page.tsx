        ...
        <Tabs defaultValue="build" className="flex min-w-0 flex-col gap-7 lg:flex-row lg:items-start">
          ...
          >
            <div className="space-y-0">
              ...
              <SettingsField controlId="provider-session-idle-conn-timeout" label={t("settings.provider.sessionIdleConnTimeout")} description={t("settings.provider.sessionIdleConnTimeoutHelp")} error={form.formState.errors.providerBuild?.sessionIdleConnTimeout?.message}><Controller control={form.control} name="providerBuild.sessionIdleConnTimeout" render={({ field }) => <DurationInput id="provider-session-idle-conn-timeout" value={field.value} onChange={field.onChange} />} /></SettingsField>
