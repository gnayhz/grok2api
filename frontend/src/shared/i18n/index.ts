    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldResolution: "输出分辨率；图片支持 1k/2k。视频 grok-imagine-video 支持 480p/720p，grok-imagine-video-1.5 额外支持 1080p，但 1080p 不能用于参考图生视频。",
          ...
          fieldDuration: "视频时长（秒）。文生视频与首帧图生视频最长 15 秒；参考图生视频 grok-imagine-video 最长 10 秒、grok-imagine-video-1.5 最长 15 秒。",
          ...
          fieldReferenceImages: "可选参考图片数组，用于参考图视频；最多 7 张，每项提供 url 或 file_id，不可与 image 同时使用。",
          fieldReferenceAudios: "可选参考音频数组，最多 3 个内置 voice_id；可单独使用或与 reference_images 组合。需上游团队开启该能力，未开启时上游返回 403。",
          ...
          noteVideoReference: "参考图视频走 /videos/generations + reference_images，最多 7 张；只传 1 张也保持参考图语义，不会被当成首帧。不可与 image 同用。参考图模式 resolution 最高 720p，grok-imagine-video-1.5 也不例外。reference_audios 使用内置 voice_id，需团队开启该能力。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldResolution: "Output resolution. Images support 1k/2k. For video, grok-imagine-video supports 480p/720p and grok-imagine-video-1.5 also supports 1080p, but 1080p cannot be used for reference-to-video.",
          ...
          fieldDuration: "Video duration in seconds. Text-to-video and first-frame image-to-video allow up to 15s. For reference-to-video, grok-imagine-video allows up to 10s and grok-imagine-video-1.5 up to 15s.",
          ...
          fieldReferenceImages: "Optional reference image array for reference-to-video, up to 7 items. Each item uses url or file_id and cannot be combined with image.",
          fieldReferenceAudios: "Optional reference audio array of up to 3 built-in voice_id values. Can be used alone or with reference_images. The upstream team must have the capability enabled; otherwise upstream returns 403.",
          ...
          noteVideoReference: "Reference-to-video uses /videos/generations with reference_images, up to 7 items. A single item still keeps reference semantics and is not promoted to a first frame. Do not combine with image. Resolution tops out at 720p in reference mode, including grok-imagine-video-1.5. reference_audios accepts built-in voice_id values and requires team entitlement.",
