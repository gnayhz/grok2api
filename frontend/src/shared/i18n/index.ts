...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  accounts: "Accounts", probe: "Probe", healthy: "Healthy", unhealthy: "Unhealthy", notTested: "Not tested", test: "Test proxy", testedOne: "Proxy test completed",
  ...
  testAll: "Check all nodes", testAllHelp: "Check every enabled proxy node now and update its health status.",
  rebalance: "Assign accounts now", rebalanceHelp: "Assign unbound accounts and balance automatic bindings once. Manual bindings are not changed.",
