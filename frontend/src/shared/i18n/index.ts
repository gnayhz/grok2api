  ...
  "zh-CN": {
    translation: {
      ...
      audits: {
        ...
        detailTitle: "请求诊断与报文详情",
        requestOverview: "请求概览",
        clientRequestBody: "请求报文",
        clientRequest: "完整报文",
        responseBodyTitle: "响应报文",
        noResponseBody: "未捕获到服务端响应报文或未启用响应报文记录。",
        copyResponseRaw: "复制响应报文",
        modeStreaming: "SSE 流式",
        requestHeaders: "HTTP 请求头",
        requestBody: "请求体 (Body)",
        requestLine: "请求行",
        upstreamDiagnostics: "上游诊断",
        copyJson: "复制 JSON",
        copyBodyJson: "复制 Body JSON",
        copyHeaders: "复制请求头",
        copyRawHttp: "复制完整 HTTP 报文",
        copyMarkdown: "复制 Markdown",
        copyMarkdownCode: "复制 Markdown 代码块",
        noRequestBody: "未捕获到客户端请求报文。",
        noRequestHeaders: "未记录到 HTTP 请求头。",
        requestBodySize: "报文大小：{{size}}",
      ...
      settings: {
        ...
        audit: {
          title: "请求审计与日志设置",
          tabTitle: "日志设置",
          retentionTitle: "日志保留与报文策略",
          retentionDays: "日志保留天数",
          retentionDaysHelp: "自动清理超过指定天数的请求审计与上游失败诊断记录。设置为 0 表示永久保留，默认为 7 天。",
          recordRequestBody: "记录客户端请求报文",
          recordRequestBodyHelp: "记录客户端发送的完整 HTTP 请求头与 Body（包含文本与多模态数据，便于报文复现与排查）。",
          recordResponseBody: "记录服务端响应报文",
          recordResponseBodyHelp: "流式输出结束后自动聚合完整的响应报文（SSE / JSON），便于在审计中查看与复制。",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        detailTitle: "Request Diagnostics & Payload",
        requestOverview: "Overview",
        clientRequestBody: "Request Body",
        clientRequest: "Full Request",
        responseBodyTitle: "Response Body",
        noResponseBody: "No response body captured or response payload recording is disabled.",
        copyResponseRaw: "Copy Response Body",
        modeStreaming: "SSE Stream",
        requestHeaders: "HTTP Request Headers",
        requestBody: "Request Body",
        requestLine: "Request Line",
        upstreamDiagnostics: "Upstream Diagnostics",
        copyJson: "Copy JSON",
        copyBodyJson: "Copy Body JSON",
        copyHeaders: "Copy Headers",
        copyRawHttp: "Copy Raw HTTP",
        copyMarkdown: "Copy Markdown",
        copyMarkdownCode: "Copy Markdown Block",
        noRequestBody: "No client request body captured.",
        noRequestHeaders: "No HTTP request headers captured.",
        requestBodySize: "Payload size: {{size}}",
