...
const resources = {
  "zh-CN": {
    translation: {
      ...
      egressProxyEditor: {
        method: "代理配置方式",
        copyHelp: "可单独配置，也可从已有节点复制代理地址及认证信息。复制仅在本次保存时执行，后续修改互不影响。",
        manual: "单独配置",
        copyFrom: "复制自",
        copyOnSave: "保存时从所选节点复制",
        reveal: "显示完整代理地址",
        hide: "隐藏完整代理地址",
        revealUnavailable: "只能查看已保存节点的代理地址",
      },
  ...
  en: {
    translation: {
      ...
      egressProxyEditor: { method: "Proxy configuration", copyHelp: "Configure this node separately or copy its proxy URL and credentials from an existing node. Copying happens once when saved; later changes remain independent.", manual: "Configure separately", copyFrom: "Copy from", copyOnSave: "Copied from the selected node when saved", reveal: "Reveal full proxy URL", hide: "Hide full proxy URL", revealUnavailable: "Only a saved node can reveal its proxy URL" },
